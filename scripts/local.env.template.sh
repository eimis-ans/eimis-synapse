...
export SYNAPSE_DB_INSTANCE_NAME="<database name of the postgresql database linked to keycloak>"
export SYNAPSE_DB_USER="<username to access the postgresql database linked to keycloak>"
